  ...
  <div class="content-section ttt-view">
    <article class="glass-card section-block ttt-head">
      <div class="head-row">
        ...
        <h2>{{ t("cottageGames.tictactoe.title") }}</h2>
...
const statusText = computed(() => {
  ...
  return isMyTurn.value ? t("cottageGames.common.yourTurn", { mark: markLabel(myColor.value) }) : t("cottageGames.common.waitingPartnerMove");
});
...
function colorLabel(color) {
  if (color === "black") return t("cottageGames.tictactoe.black");
  if (color === "white") return t("cottageGames.tictactoe.white");
...
function handleEvent(e) {
  ...
  if (e.type === "STATE") {
    ...
    showMessage(t("cottageGames.tictactoe.inviteToast", { name: from }));
